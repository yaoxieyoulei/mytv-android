...
@Composable
private fun UiFontScaleRatioItem(
    modifier: Modifier = Modifier,
    scaleRatio: Float,
    onSelected: () -> Unit = {},
) {
    ...
    Card(
        ...
        Text(
            text = "×${DecimalFormat("#.#").format(scaleRatio)}",
...
@Composable
private fun UiFontScaleRatioScreenPreview() {
    MyTVTheme {
