package top.yogiczy.mytv.tv.ui.screensold.update
...
import top.yogiczy.mytv.tv.ui.screensold.update.components.UpdateContent
...
fun UpdateScreen(
    ...
    PopupContent(
        ...
        UpdateContent(
            modifier = modifier
                .backHandler { updateViewModel.visible = false }
